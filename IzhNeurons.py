...
for idx in range(Niter):
    ...
    params = {
        ...
        "ampl_1_e" : randinterval(5.0, 15.0) * mS, # [0.2 10],
        "ampl_2_e" : randinterval(5.0, 15.0) * mS, # [0.2 10],
        "ampl_3_e" : randinterval(5.0, 15.0) * mS, # [0.2 10],
        "ampl_4_e" : randinterval(5.0, 15.0) * mS, # [0.2 10],
